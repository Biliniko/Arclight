...
public interface ItemMeta extends Cloneable, ConfigurationSerializable, PersistentDataHolder {
    ...
    // Paper API - Start
    /**
     * Gets the display name as a component array.
     *
     * @return the display name components
     */
    @Nullable
    net.md_5.bungee.api.chat.BaseComponent[] getDisplayNameComponent();

    /**
     * Sets the display name using component array.
     *
     ...
     * @param name the name to set
     */
    default void setItemName(@Nullable String name) {
        setDisplayName(name);
    }
    // Paper API - End
    ...
    // Paper API - Lore Components
    /**
     * Gets the lore as component arrays.
     *
    ...
    // Paper API - Item Model
    /**
     * Checks for existence of an item model.
     *
     * @return true if this has an item model
     */
    default boolean hasItemModel() {
        return hasCustomModelData();
    }
    // Paper API - End Item Model
